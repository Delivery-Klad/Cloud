...
namespace Tree
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            bg = new Background();
            bg.Buffer();
            bg_texindex = Textures.AddTexture("textures/grass.jpg");
            bark_texindex = Textures.AddTexture("textures/bark_c.png");
            fireflare_texindex = Textures.AddTexture("textures/flare.png");
